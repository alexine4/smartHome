...
router.patch('/update/:typeId', passport.authenticate('jwt', { session: false }), controller.updateByName)
router.delete('/delete/:typeId', passport.authenticate('jwt', { session: false }), controller.deleteByName)
